...
public class OrdersR {
    ...
    // Duplicate of @Id as a regular field to allow range queries via N1QL
    ...
    public OrdersR(int o_orderkey, String o_custkey, String o_orderstatus, double o_totalprice,
