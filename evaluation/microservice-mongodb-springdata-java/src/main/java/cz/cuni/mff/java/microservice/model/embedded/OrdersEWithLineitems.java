...
@CompoundIndexes({
        @CompoundIndex(name = "idx_lineitems_l_id",       def = "{'o_lineitems.l_id': 1}"),
        @CompoundIndex(name = "idx_lineitems_l_orderkey", def = "{'o_lineitems.l_orderkey': 1}"),
        @CompoundIndex(name = "idx_lineitems_l_partkey",  def = "{'o_lineitems.l_partkey': 1}"),
        @CompoundIndex(name = "idx_lineitems_l_suppkey",  def = "{'o_lineitems.l_suppkey': 1}"),
        @CompoundIndex(name = "idx_lineitems_l_ps_id",    def = "{'o_lineitems.l_ps_id': 1}")
})
public class OrdersEWithLineitems {
    ...
    public OrdersEWithLineitems(int o_orderkey, int o_custkey, String o_orderstatus,
                                double o_totalprice, LocalDate o_orderdate, String o_orderpriority,
