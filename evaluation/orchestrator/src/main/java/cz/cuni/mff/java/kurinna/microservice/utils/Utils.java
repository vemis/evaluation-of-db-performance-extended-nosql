...
public class Utils {
    public static final String[] ALL_SERVICES = new String[] {
            "ebean", "cayenne", "jdbc", "jooq", "myBatis", "springDataJpa", "morphia", "couchbaseSpringData", "springDataMongoDB", "mongooseMongoDBJavascript", "ottomanJSCouchbaseJavascript"
    };

    /** Services that implement the embedded document model (r1–r9). */
    public static final String[] EMBEDDED_SERVICES = new String[] { "morphia", "couchbaseSpringData", "springDataMongoDB", "mongooseMongoDBJavascript", "ottomanJSCouchbaseJavascript" };
